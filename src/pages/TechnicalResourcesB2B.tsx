...
import { Eye, EyeOff, LogOut, Shield, Wrench, CheckCircle, ClipboardCheck, Gift } from "lucide-react";
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-12 sm:space-y-16">
        ...
        <section className="rounded-xl border border-border/50 bg-card/30 p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-base sm:text-lg font-semibold text-foreground tracking-tight">Included in Package (Free)</h3>
          </div>
          <div className="space-y-3 text-sm">
            {includedServices.map((item, i) => (
              <div key={i} className="flex items-center justify-between py-2 border-b border-border/20 last:border-0">
                <span className="text-foreground">{item.service}</span>
                <span className="text-muted-foreground line-through">AED {item.value}</span>
              </div>
            ))}
          </div>
        ...
        <section className="rounded-xl border border-border/50 bg-card/30 p-6">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="text-base sm:text-lg font-semibold text-foreground tracking-tight">Installation Guarantee</h3>
          </div>
          <p className="text-sm text-muted-foreground">
            We offer our installation guarantee on top of the manufacturer's warranty, ensuring comprehensive protection and peace of mind for your investment.
          </p>
        </section>
