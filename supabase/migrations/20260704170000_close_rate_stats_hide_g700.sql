-- g700_customizer is a configurator we send to existing customers, not a lead
-- source — permanently exclude it from close-rate analytics (data stays in CRM).
-- Only change vs 20260704160000: `b.funnel_key <> 'g700_customizer'` in enriched_all.
...
as $$
  ...
  enriched_all as (
    ...
    where b.funnel_key <> 'g700_customizer'
      and (p_exclude_sources is null or not (b.source_group = any(p_exclude_sources)))
