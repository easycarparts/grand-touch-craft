-- Close-rate / sales analytics for the admin dashboard.
-- Junk leads are excluded everywhere so duplicates and spam do not distort rates.
  ...
  select jsonb_build_object(
    ...
    'by_owner', (
      ...
      from (
        ...
        group by coalesce(au.full_name, au.email, 'Unassigned')
      ) s
    ),
    'by_month', (
